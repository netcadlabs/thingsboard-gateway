...
DEFAULT_TB_GATEWAY_CONF_WIN = "C:/thingsboard-gateway/config/tb_gateway.yaml"


def _get_config():
    print(sys.argv)
    tb_gateway_config_file = None
    ...
    if tb_gateway_config_file is None:
        ...
        if path.isfile(config_file):
            tb_gateway_config_file = config_file
